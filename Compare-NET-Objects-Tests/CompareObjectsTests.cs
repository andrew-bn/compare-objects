...
namespace KellermanSoftware.CompareNetObjectsTests
{
    ...
    public class CompareObjectsTests
    {
        ...
        public void CollectionDisorderedWithSpecMatch()
        {
            ...
            Assert.IsTrue(_compare.Differences.Where(d => d.Object1Value == "(null)" || d.Object2Value == "(null)").ToArray().Length == 0);
        ...
        public void CollectionDisorderedWithSpecMatchAndOffByCount()
        {
            ...
            Assert.AreEqual(_compare.Differences.Where(d => d.Object1Value == Level.Company.ToString() && d.Object2Value == Level.Department.ToString()).Count(), 2);

            Assert.AreEqual(_compare.Differences.Where(d => d.ToString().Contains("Match(Description")).Count(), 6);

            Assert.AreEqual(_compare.Differences.Where(d => d.Object1Value == "(null)" || d.Object2Value == "(null)").Count(), 2);
        ...
        public void CollectionFirstBiggerThanSecondWithSpecMatchHasSpecMatchInResult()
        {
            ...
            Assert.IsTrue(_compare.Differences.Where(d => d.Object1Value == "(null)" || d.Object2Value == "(null)").Count() > 0);
            Assert.IsTrue(_compare.Differences.Where(d => d.ToString().Contains("Match(Description")).Count() > 0);
        ...
        public void WhenSecondEntityHasLinqEnumeratorPropertyThenDetectsDifferences()
        {
            ...
            var oc = new CompareObjects()
            {
                IgnoreObjectTypes = true,
                CompareChildren = true,
            };

            var condition = oc.Compare(a, b);
            Console.WriteLine(oc.DifferencesString);
